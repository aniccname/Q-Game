...
const exampleInfo = {
  ...
  player : {
      tiles : [makeTile("blue", "8star"), makeTile("green", "circle"),
        makeTile("red", "star"), makeTile("orange", "clover"),
        makeTile("yellow", "square"), makeTile("purple", "diamond"),
      ],
      score: 77
  },
}
root.render(
  <StrictMode>
    <Game turnInfo={exampleInfo} submission={console.log} isPlaying={true}/>
  </StrictMode>
);